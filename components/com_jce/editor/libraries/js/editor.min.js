...
(function() {
    var winLoaded = false,
        each = tinymce.each,
        explode = tinymce.explode, DOM = tinymce.DOM,
    ...
    var WFEditor = {
        ...
        load: function() {
            ...
            tinyMCE.onAddEditor.add(function(mgr, ed) {
                ...
                each(lookup, function(o, k) {
                    if (tinymce.inArray(plugins, k) < 0) {
                        delete lookup[k];
                    }
                });
        ...
        _toggleEditor: function(el) {
            ...
            if (!ed) {
                ...
                if (ed.isHidden()) {
                    ...
                    // set textarea height
                    DOM.setStyle(ed.getElement(), 'height', ed.getContainer().offsetHeight);
        ...
        _getEditor: function(el) {
            ...
            // check for codemirror iframe
            var codemirror = DOM.get(ed.id + '_editor_source_iframe');

            // return codemirror
            if (codemirror && !DOM.isHidden(ed.id + '_editor_source')) {
                return codemirror.contentWindow.SourceEditor;
            }
        ...
        _toggleTab: function(ed, tab) {
            ...
            if (!ed.isHidden() && !DOM.hasClass(el.parentNode, 'mce-fullscreen')) {
