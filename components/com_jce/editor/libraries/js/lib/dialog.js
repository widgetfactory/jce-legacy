    ...
    $.extend($.Plugin, {
        ...
        setMargins: function(e) {
            ...
            if (e) {
                ...
                $('#margin_check').prop('checked', s).prop('disabled', false).trigger('checkbox:check').prev('label').removeClass('disabled');
            } else {
        ...
        setBorder: function() {
            ...
            $('#border~:input, #border~span, #border~label').attr('disabled', !s).toggleClass('ui-text-muted', !s);
