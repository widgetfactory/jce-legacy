...
?>
      <div class="ui-form-row">
        <label for="block_wordspacing" class="ui-form-label ui-width-2-10"><?php echo WFText::_('WF_STYLES_BLOCK_WORDSPACING');?></label>
            ...
            <div class="ui-form-controls ui-width-5-10">
              <select id="block_wordspacing" class="mceEditableSelect"></select>
      ...
      <div class="ui-form-row">
        <label for="block_letterspacing" class="ui-form-label ui-width-2-10"><?php echo WFText::_('WF_STYLES_BLOCK_LETTERSPACING');?></label>
            ...
            <div class="ui-form-controls ui-width-5-10">
              <select id="block_letterspacing" class="mceEditableSelect"></select>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-5-10">
          <select id="block_vertical_alignment" class="mceEditableSelect"></select>
        </div>
      </div>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-5-10">
          <select id="block_text_align" class="mceEditableSelect"></select>
        </div>
      </div>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-5-10">
          <select id="block_whitespace" class="mceEditableSelect"></select>
        </div>
      </div>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-5-10">
          <select id="block_display" class="mceEditableSelect"></select>
        </div>
      </div>
