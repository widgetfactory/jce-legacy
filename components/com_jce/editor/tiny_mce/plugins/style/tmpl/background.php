...
?>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-4-10">
          <select id="background_repeat" class="mceEditableSelect"></select>
        </div>
      </div>
      ...
      <div class="ui-form-row">
        ...
        <div class="ui-form-controls ui-width-4-10">
          <select id="background_attachment" class="mceEditableSelect"></select>
        </div>
      </div>
      ...
      <div class="ui-form-row">
        <label for="background_hpos" class="ui-form-label ui-width-2-10"><?php echo WFText::_('WF_STYLES_BACKGROUND_HPOS');?></label>
          ...
          <div class="ui-form-controls ui-width-4-10 ui-margin-right">
              <select id="background_hpos" class="mceEditableSelect"></select>
          </div>
          <div class="ui-form-controls ui-width-2-10">
      ...
      <div class="ui-form-row">
        <label for="background_vpos" class="ui-form-label ui-width-2-10"><?php echo WFText::_('WF_STYLES_BACKGROUND_VPOS');?></label>
          ...
          <div class="ui-form-controls ui-width-4-10 ui-margin-right">
              <select id="background_vpos" class="mceEditableSelect"></select>
            </div>
          <div class="ui-form-controls ui-width-2-10">
