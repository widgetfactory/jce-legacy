  ...
  <div class="ui-width-3-10">
    ...
    <div class="ui-form-row ui-grid ui-grid-small">
      ...
      <div class="ui-form-controls ui-width-7-10">
        <select id="border_style_top" class="mceEditableSelect"></select>
      </div>
    </div>
    ...
    <div class="ui-form-row ui-grid ui-grid-small">
      ...
      <div class="ui-form-controls ui-width-7-10">
        <select id="border_style_right" class="mceEditableSelect"></select>
      </div>
    </div>
    ...
    <div class="ui-form-row ui-grid ui-grid-small">
      ...
      <div class="ui-form-controls ui-width-7-10">
        <select id="border_style_bottom" class="mceEditableSelect"></select>
      </div>
    </div>
    ...
    <div class="ui-form-row ui-grid ui-grid-small">
      ...
      <div class="ui-form-controls ui-width-7-10">
        <select id="border_style_left" class="mceEditableSelect"></select>
      </div>
    </div>
  </fieldset>
  </div>
    ...
    <fieldset>
      ...
      <div class="ui-form-row ui-grid ui-grid-small">
        <div class="ui-form-controls ui-width-5-10">
          <select id="border_width_top" class="mceEditableSelect"></select>
        </div>
        <div class="ui-form-controls ui-width-5-10">
      ...
      <div class="ui-form-row ui-grid ui-grid-small">
        <div class="ui-form-controls ui-width-5-10">
          <select id="border_width_right" class="mceEditableSelect"></select>
        </div>
        <div class="ui-form-controls ui-width-5-10">
      ...
      <div class="ui-form-row ui-grid ui-grid-small">
        <div class="ui-form-controls ui-width-5-10">
          <select id="border_width_bottom" class="mceEditableSelect"></select>
        </div>
        <div class="ui-form-controls ui-width-5-10">
      ...
      <div class="ui-form-row ui-grid ui-grid-small">
        <div class="ui-form-controls ui-width-5-10">
          <select id="border_width_left" class="mceEditableSelect"></select>
        </div>
        <div class="ui-form-controls ui-width-5-10">
